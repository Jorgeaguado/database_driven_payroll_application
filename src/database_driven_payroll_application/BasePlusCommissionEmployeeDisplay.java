...
public class BasePlusCommissionEmployeeDisplay extends JFrame 
{

   	private BasePlusCommissionEmployee currentEntry;
   	private BasePlusCommissionEmployeeQueries basePlusCommissionEmployeeQueries;
   	private List< BasePlusCommissionEmployee > results;   
	...
	private JLabel baseSalaryLabel = new JLabel();
	...
	private JFormattedTextField baseSalaryTextField;
	private NumberFormat baseSalaryFormat;

	private JFormattedTextField bonusTextField;
	private NumberFormat bonusFormat;

   // no-argument constructor
   public BasePlusCommissionEmployeeDisplay(ConnectDB connect)
   {
	   super( "BasePlusCommission Employee" ); 

	   basePlusCommissionEmployeeQueries = new BasePlusCommissionEmployeeQueries(connect);
	   initTextFields();
   ...
   private void initTextFields()
   {
	   ...
	   baseSalaryTextField = new JFormattedTextField(baseSalaryFormat);
	   baseSalaryTextField.setValue(new Double(amount));
	   baseSalaryTextField.setColumns(10);
   ...
   private void addFieldsToPanel()
   {
     	...
     	displayPanel.add( baseSalaryTextField );
